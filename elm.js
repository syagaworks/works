		...
		switch (msg.$) {
			...
			case 'GoHome':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{category: $author$project$Main$Home}),
					$elm$core$Platform$Cmd$none);
			case 'GoChat':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{category: $author$project$Main$Chat}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{category: $author$project$Main$Games}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$myHeader = function (model) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						A3($mdgriffith$elm_ui$Element$rgb255, 94, 103, 107)),
						$mdgriffith$elm_ui$Element$alignLeft
					]),
				$mdgriffith$elm_ui$Element$text('   syaga works'))
			]));
};
...
var $author$project$Main$myBody = function (model) {
	...
	switch (_v0.$) {
		case 'Home':
			return A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Under Construction.')
					]));
		case 'Games':
			return A2(
				$mdgriffith$elm_ui$Element$column,
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Games'),
						A2(
						$mdgriffith$elm_ui$Element$link,
						_List_Nil,
						{
							label: $mdgriffith$elm_ui$Element$text('三文字しりとり(2020/05)'),
						...
						_List_Nil,
						{
							label: $mdgriffith$elm_ui$Element$text('Leave Me Alone(2018/11)'),
						...
						_List_Nil,
						{
							label: $mdgriffith$elm_ui$Element$text('smart shopping(2018/10)'),
						...
						_List_Nil,
						{
							label: $mdgriffith$elm_ui$Element$text('c2(2016/04)'),
...
var $author$project$Main$GoChat = {$: 'GoChat'};
var $author$project$Main$GoGames = {$: 'GoGames'};
...
var $author$project$Main$myElement = function (msg) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $author$project$Main$mySideBar = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				{
					angle: (3 * $elm$core$Basics$pi) / 4,
					steps: _List_fromArray(
						[
							A3($mdgriffith$elm_ui$Element$rgb255, 240, 0, 245),
							A3($mdgriffith$elm_ui$Element$rgb255, 0, 240, 245)
						])
				})
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$GoHome)
					]),
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$GoGames)
					]),
				$author$project$Main$myElement(
					$mdgriffith$elm_ui$Element$text('GAMES'))),
				A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$GoChat)
					]),
				$author$project$Main$myElement(
...
var $author$project$Main$myRowOfStuff = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$mySideBar(model),
				$author$project$Main$myBody(model)
			]));
};
var $author$project$Main$myHeaderBody = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Main$myHeader(model),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_Nil,
		$author$project$Main$myHeaderBody(model));
};
